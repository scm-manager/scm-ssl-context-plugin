...
Provides information about SSL connections like rejected certificates

## Documentation

Find out how this plugin works on the [plugin documentation page](https://www.scm-manager.org/plugins/scm-ssl-context-plugin/docs/).
